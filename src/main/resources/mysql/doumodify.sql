...
CREATE TABLE `provisioned_product`(
                            ...
                            `starter_id` varchar(100) NOT NULL COMMENT '实例申请人ID',
...
CREATE TABLE `application` (
                         ...
                         `starter_id` varchar(100) NOT NULL COMMENT '申请人ID',
                         `role_id` int(11) NOT NULL COMMENT '角色ID',
                         `product_version_id` varchar(100) COMMENT '产品版本ID',
                         `product_id` varchar(100) NOT NULL COMMENT '产品ID',
                         ...
                         `plan_id` varchar(100) NOT NULL COMMENT '启动计划ID',

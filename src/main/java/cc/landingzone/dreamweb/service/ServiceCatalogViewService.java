...
public class ServiceCatalogViewService {
     ...
     * @throws Exception
     */
    public String getNonLoginPreUrl(String servicecatalogProductId, String provisionedProductName, String region,
                                    User user,
                                    UserRole userRole, String servicecatalogProductVersionId,
                                    String servicecatalogPortfolioId, String regionSelect)
        throws Exception {
        String signInUrl = "";
        ...
        signInUrl = generateSignInUrl(signInToken, servicecatalogProductId, provisionedProductName, signinEndpoint,
            servicecatalogProductVersionId, servicecatalogPortfolioId, regionSelect);
     ...
     * @param: 地域、用户、角色
     */
    public Client createClient(String region, User user, UserRole userRole, String servicecatalogProductId)
        throws Exception {
        String stsEndpoint = EndpointEnum.STS.getEndpoint();
     ...
     * @param: 地域、用户、角色
     */
    public Client createClient2(String region, User user, UserRole userRole) throws Exception {
        String stsEndpoint = EndpointEnum.STS.getEndpoint();
        ...
        // 访问令牌服务获取临时AK和Token
        CommonResponse commonResponse = requestAccessKeyAndSecurityToken2(region, roleArn, samlProviderArn,
     ...
     * @throws ClientException
     */
    private CommonResponse requestAccessKeyAndSecurityToken2(String region, String roleArn,
                                                             String samlProviderArn, String samlAssertion,
                                                             String stsEndpoint)
        throws ClientException {
        DefaultProfile profile = DefaultProfile.getProfile(region, "", "");
     ...
     */
    private String generateSignInUrl(String signInToken, String servicecatalogProductId, String provisionedProductName,
                                     String endpoint, String servicecatalogProductVersionId,
                                     String servicecatalogPortfolioId, String regionSelect)
        throws UnsupportedEncodingException {
        ...
        String base64EncodedControlString = Base64.getUrlEncoder().encodeToString(
            controlString.getBytes(StandardCharsets.UTF_8));

...
//        http.anonymous();
        http
                ...
                .antMatchers("/welcome/*", "/user/getUserInfo.do", "/sso/*","/tools/*","/aliyunTools/*.do", "/slsConfig/*","/userRole/*", "/slsView/*","/serviceCatalogView/*","/userProduct/*", "/task/*", "/application/*", "/index.html", "/system/getIndexLogoPage.do").hasAnyRole("GUEST", "ADMIN")

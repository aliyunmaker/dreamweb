...
public class SystemController extends BaseController implements InitializingBean {
    ...
    public void getLoginUserName(HttpServletRequest request, HttpServletResponse response) {
    ...
    public void getIndexLogoPage(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            if (CommonConstants.ENV_ONLINE) {
                ...
                String jarFilePath =
                    ClassUtils.getDefaultClassLoader().getResource("").getPath().replace("!/BOOT-INF/classes!/", "");
                ...
                logoDiv =
                    "<div align=\"center\"><i style=\"font-size:30px;margin-top:5px;color:#CFDEEF;animation-duration: 20s;\" class=\"fa fa-sun-o fa-spin\" aria-hidden=\"true\"></i></div><div align='center' style='background-color:#FF594C;margin-top:5px;font-size: 12px;'><font "

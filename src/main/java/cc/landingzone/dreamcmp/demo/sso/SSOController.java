...
import cc.landingzone.dreamcmp.common.utils.FreeMarkerUtils;
import cc.landingzone.dreamcmp.common.utils.JsonUtils;
import cc.landingzone.dreamcmp.demo.sso.sp.RAMSamlHelper;
import cc.landingzone.dreamcmp.demo.sso.sp.SPHelper;
    ...
    public void downloadToken(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            DefaultProfile profile = DefaultProfile.getProfile(
                ...
                cc.landingzone.dreamcmp.common.CommonConstants.Aliyun_AccessKeyId,
                cc.landingzone.dreamcmp.common.CommonConstants.Aliyun_AccessKeySecret);
            // 获取已经登录用户的信息
            String username = SecurityContextHolder.getContext().getAuthentication().getName();

package cc.landingzone.dreamcmp.demo.sso;


import org.apache.commons.lang3.StringUtils;

import cc.landingzone.dreamcmp.common.CommonConstants;
import cc.landingzone.dreamcmp.common.model.enums.SSOSpEnum;
import cc.landingzone.dreamcmp.demo.ssologin.model.SSOUserRole;
...
//            "acs:ram::1764263140474643:role/super2,acs:ram::1764263140474643:saml-provider/superAD");
    ...
    static {
        ...
        addSSOUsersRoles();
        String idpEntityId = properties.getProperty("dreamcmp.idp_entityid");
...
//
    ...
    private static final String ALIYUN_USER_CLOUDSSO_IDENTIFIER = "https://signin-cn-shanghai.alibabacloudsso.com/saml/sp/d-00prip2g4v37";
    private static final String ALIYUN_USER_CLOUDSSO_REPLY_URL = "https://signin-cn-shanghai.alibabacloudsso.com/saml/acs/17355dae-0e24-4d15-806a-cef4974e13aa";
...
//    private static final String AWS_USER_REPLY_URL = "[aws user sso] must be replaced replyUrl";// "https://us-east-2.signin.aws.amazon.com/platform/saml/acs/6b9f0caa-6290-41d0-b4de-bd190139324e";
    ...
    public static String getSSOSpUserId(SSOSpEnum ssoSp) {
        switch (ssoSp) {
            case aliyun_user:
                return CommonConstants.Aliyun_TestAccount_UserId;
            case aliyun:
            case aliyun_user_cloudsso:
            case aws:
            case aws_user:
